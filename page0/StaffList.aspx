<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StaffList.aspx.cs" Inherits="Project5.StaffListForm" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br /><br /><br />
            <h3>List of Staff:</h3>
            <asp:ListBox ID="myListResults" runat="server" Height="285px" Width="334px"></asp:ListBox>
            <br /><br />
